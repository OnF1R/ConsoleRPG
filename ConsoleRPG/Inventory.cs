...
namespace ConsoleRPG
{
    ...
    internal class Inventory
    {
        ...
        public List<BaseItemRecipe> ListRecipes { get; set; }
        ...
        public Inventory()
        {
            ...
            ListRecipes = new List<BaseItemRecipe>();
        ...
        public Item SearchByUniqID(Guid uniqID)
        {
            foreach (Item item in ListInventory)
            {
        ...
        public void BuyRecipe(int Cost, BaseItemRecipe recipe)
        {
            List<Item> CurrenciesList = GetCurrencies();
        ...
        public void RemoveCurrencies(int Cost)
        {
            List<Item> CurrenciesList = GetCurrencies();
        ...
        public void AddCraft(BaseItemRecipe recipe)
        {
        ...
        public void AddItem(Item Item)
        {
            if (Item.IsStacable)
            {
                AnsiConsole.MarkupLine("Вы получили {0} ([{1}]{2})[/] x{3}", Item.Name, Item.RarityColor, Item.Rarity, Item.Count);
            }
            else
            {
                AnsiConsole.Markup("Вы получили {0} ([{1}]{2}[/]): ", Item.Name, Item.RarityColor, Item.Rarity);
                Item.ItemInfo(Item);
            }
