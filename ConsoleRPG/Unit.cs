...
namespace ConsoleRPG
{
    ...
    abstract class Unit
    {
        ...
        public Dictionary<SpellIdentifierEnum, BaseSpell> UnitSpells { get; set; } = new Dictionary<SpellIdentifierEnum, BaseSpell>();
        ...
        public Unit()
        {
            ...
            AddComponent(new ManaRegenerationAmplificationCharacteristic { Amplification = 0, AmplificationPerLevel = 0 });
        ...
        public void RestoreMana(int restoreMana, IEntity entity)
        {
        ...
        {
            int coefficient = MaxMana / CurrentMana;
            return 100 / coefficient;
        }
        ...
        public void CheckApplyingEffects(params IEntity[] Entities)
        {
            ...
            foreach (var item in items)
            {
                ...
                {
                    if (new SerializableRandom().Next(1, 101) < effect.Value)
                    {
        ...
        public virtual BaseSpell ChooseSpell()
        {
            var rand = new SerializableRandom();
            return UnitSpells.ElementAt(rand.Next(0, UnitSpells.Count)).Value;
        }
        ...
        public bool IsCrit()
        {
            if (GetCriticalChance() >= new SerializableRandom().Next(1, 101))
            {
                return true;
            }
        ...
        public int ManaRegenerashionAmplification()
        {
            return GetComponent<ManaRegenerationAmplificationCharacteristic>().Amplification;
        }
